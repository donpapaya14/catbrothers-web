---
title: "Essential Vaccines for Indoor Cats According to AVMA"
description: "Do indoor cats still need vaccinations? Discover the latest guidelines from the American Veterinary Medical Association."
pubDate: 2026-05-13
category: "cat-health"
tags: ["indoor cat vaccinations avma", "cat health", "vaccination schedule", "feline wellness", "rabies vaccine", "feline leukemia virus", "feline immunodeficiency virus"]
author: "Vladys Z."
readingTime: 5
...
sources:
  - "American Veterinary Medical Association. (2020). Vaccination Guidelines."
  - "American Association of Feline Practitioners. (2020). Feline Vaccination Guidelines."
  - "Centers for Disease Control and Prevention. (2020). Rabies Vaccination."
  - "World Health Organization. (2020). Vaccination."
  - "Food and Drug Administration. (2020). Animal Vaccines."
draft: false
---
...
| --- | --- | --- |
| Rabies | Core | 12-16 weeks |
| FVR/FCV/FPV | Core | 6-8 weeks |
| FeLV | Non-Core | 12-16 weeks (if at high risk) |
| FIV | Non-Core | 12-16 weeks (if at high risk) |
...
## Practical Summary
* Consult with your veterinarian to determine the best vaccination schedule for your indoor cat
* Follow the recommended vaccination schedule to protect your cat against serious diseases
* Monitor your cat for signs of an adverse reaction after vaccination
* Provide a healthy lifestyle for your cat, including a balanced diet, regular exercise, and plenty of love and attention
* Stay informed about the latest vaccination guidelines and research
* Consider using products like [ cat vaccine record book en Amazon](https://www.amazon.com/s?k=+cat+vaccine+record+book&tag=vds96-20) to keep track of your cat's vaccination history
* Always follow the instructions provided by your veterinarian for post-vaccination care
* Keep your cat indoors to reduce the risk of exposure to diseases like FeLV and FIV
