...
CATEGORY_NAMES = {
    "salud-felina": "Salud Felina",
    "alimentacion": "Alimentación para Gatos",
    "juguetes": "Juguetes para Gatos",
    "comportamiento": "Comportamiento Felino",
    "productos": "Productos para Gatos",
}

AMAZON_TAG = os.getenv("AMAZON_TAG", "vladys-21")
SITE_URL = os.getenv("SITE_URL", "https://catbrothers-web.vercel.app")
